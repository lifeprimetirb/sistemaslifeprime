...
exports.remove = exports.update = exports.showByUser = exports.show = exports.store = exports.index = void 0;
...
const ShowQueuesByUserService_1 = __importDefault(require("../services/QueueService/ShowQueuesByUserService"));
...
const showByUser = async (req, res) => {
    ...
    const { companyId } = req.user;
    const queue = await (0, ShowQueuesByUserService_1.default)(userId, companyId);
    return res.status(200).json(queue);
};
